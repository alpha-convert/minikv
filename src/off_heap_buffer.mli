...
val unsafe_get_int32_le : t @ read local -> pos:int -> int
...
val unsafe_set_int32_le_exn : t @ local -> pos:int -> int -> unit
...
val blit_to_bytes : t @ local read -> Bytes.t -> src_pos:int -> dst_pos:int -> len:int -> unit
